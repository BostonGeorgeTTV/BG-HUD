...
const Globe = ({ veh, heading = 0, mileage, mileageUnit }: TypeClassic) => {
  const iGear =
  ...
  return (
    <div
      className="veh-hud-globe -translate-x-3 translate-y-12 4k:translate-y-0 4k:-translate-x-10"
      ...
      >
        <div className="absolute" style={{ width: "93%" }}>
          ...
          >
            ...
            <div className="mb-12 z-10 w-full">
              {isVehCar ? (
                ...
                <div className="scale-90">
                  <img
                    className="animate-plane-dial -z-10 opacity-75"
                    src="images/vehicle_hud/globe_plane_bg.svg"
                    alt="plane_bg"
                  />
                </div>
              ) : (
            ...
            <div
              className="absolute w-[290px] h-[290px] bg-center bg-cover"
              style={{ backgroundImage: "url(images/vehicle_hud/globe_bg.png)" }}
            />
          </CircularProgressbarWithChildren>
        </div>
      </CircularProgressbarWithChildren>
