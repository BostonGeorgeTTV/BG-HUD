...
const GrtTwo = ({ veh, heading = 0, mileage, mileageUnit }: TypeClassic) => {
      ...
      >
        <div className="absolute" style={{ width: "90%" }}>
          ...
          >
            ...
            <MileagePill mileage={mileage} mileageUnit={mileageUnit} accent="#ffffff" compact style={{ left: '50%', top: 46, transform: 'translateX(-50%)' }} />
